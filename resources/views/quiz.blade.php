...
<head>
    ...
    <style>
        ...
        .option:active {
            background-color: #D3D3D3; /* Color on hover */
        }
        .selected {
            background-color: #D3D3D3; /* Light gray color */
        }
        .selected.bg-gray-200 {
            background-color: #E5E7EB; /* Gray-200 color */
        }
        .option.active\:bg-yellow-300 {
            background-color: #d6d6d6; /* Tailwind's yellow-300 */
        }
...
<body>
        ...
        <div class="flex flex-col md:flex-row h-screen">
            <div class="md:w-4/6 md:px-12 px-4 order-2 md:order-1 flex flex-col h-screen">
                <div class="md:flex-col md:flex-grow md:flex md:justify-center">
                    ...
                    <div class="mt-4">
                        <div class="flex justify-center h-5 w-2/5 mx-auto">
                        ...
                        <h1 id="questionText" class="mt-4 text-center font-bold md:text-start md:ml-20 text-slate-700 md:text-md xl:text-2xl 2xl:text-4xl xl:mt-4"></h1>
                    </div>
                    <div id="optionsContainer" class="mx-auto xl:m-12 bg-slate-300 rounded-3xl flex flex-wrap justify-center py-4 mt-4 items-end md:px-4 lg:px-18">
                        <!-- Options will be generated here -->
                    </div>
                    
                    <div class="flex flex-grow md:flex-grow-0 justify-center items-center xl:justify-start xl:ml-10 md:mt-4 md:px-6 py-5">
                        <div class="w-40 xl:grow-0 border-gray-300 border rounded-full py-4 px-2 text-center xl:px-4 xl:py-2 bg-white font-bold text-sm xl:text-xl mr-2 cursor-pointer" onclick="backQuestion()">Kembali</div>
                        <div id="selanjutnya" class="grow xl:grow-0 border rounded-full py-4 px-14 xl:px-8 xl:py-2 bg-yellow-300 text-center text-sm font-bold xl:text-xl ml-2 cursor-pointer hover:bg-yellow-500" onclick="nextQuestion()">Selanjutnya</div>
                    </div>
                </div>                
            </div>            
            <div class="md:flex-auto order-1 md:order-2 px-14 md:items-center md:flex">
                <div class="bg-cover bg-center w-72 rounded-3xl h-60 md:h-1/2 mx-auto flex my-4 xl:h-4/5" style="background-image: url('./assets/main/adudu.jpg');">
                </div>
            </div>
    ...
    <script>
        const quizData = [
            { 
                ...
                options: [
                    { text: "Tidak", image: "no.png" },
                    { text: "Ya", image: "yes.png" }
                ],
        ...
        const iceBreakingData = [
            { 
                ...
                options: [
                    { text: "Kucing, karena bisa tidur sepanjang hari", image: "cat.png" },
                    { text: "Burung, supaya bisa terbang ke mana saja", image: "bird.png" },
                    { text: "Anjing, agar selalu dikelilingi teman-teman", image: "dog.png" },
                    { text: "Jerapah, supaya bisa melihat Monas", image: "girafe.png" }
                ],
            ...
            { 
                ...
                options: [
                    { text: "Bantal, Untuk tidur nyaman", image: "bantal.png" },
                    { text: "Baju, Agar Tidak Bau", image: "baju.png" },
                    { text: "Do’a, Agar Selamat", image: "pray.png" },
                    { text: "Temen, Agar tidak Kesepian", image: "2 person.png" }
                ],
            ...
            { 
                ...
                options: [
                    { text: "Teleportasi, Supaya bisa hemat gak naik angktot", image: "doll.png" },
                    { text: "Terbang, Untuk Balapan sama Burung", image: "bird anim.png" },
                    { text: "Pengendali Air, Agar bisa jadi Bombe", image: "wave.png" },
                    { text: "Kuat, Agar Jadi kuli Bangunan", image: "strong.png" }
                ],
    ...
    backgroundDiv.style.backgroundImage = `url('./assets/main/quiz/${currentData[currentSet === 0 ? currentQuiz : currentIceBreaking].img}')`;
    ...
    if (currentSet === 0) {
        ...
        currentData[currentQuiz].options.forEach((option, index) => {
            ...
            optionDiv.className = "bg-white rounded-3xl mx-4 flex flex-col items-center w-40 xl:h-80 pt-4 my-1 xl:justify-end xl:mx-6 xl:w-56 option cursor-pointer";
        ...
        currentData[currentIceBreaking].options.forEach((option, index) => {
            const optionDiv = document.createElement('div');
            optionDiv.className = "rounded-3xl mx-4 flex flex-col items-center w-40 xl:h-80 pt-4 my-1 xl:justify-end xl:mx-2 xl:w-40 option cursor-pointer";
            optionDiv.onclick = () => selectOption(index);
