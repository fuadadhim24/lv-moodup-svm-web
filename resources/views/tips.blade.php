...
<body>
    ...
    <section id="hero"
        class="sm:w-full sm:items-start bg-white flex flex-col items-center justify-center h-screen pt-22 sm:pt-32 md:pt-32 lg:pt-0 pt-80">
        <div class="flex w-full mt-40 mx-auto">
            <h1 class="flex-1 text-center sm:text-start sm:ml-14 font-bold text-lg">Hasil Tes Kesehatan Mental</h1>
            <a href="{{ route('welcome') }}"
                class="mr-10 xl:grow-0 md:mr-10 border rounded-full py-2 px-8 xl:px-8 xl:py-2 bg-yellow-300 text-center text-sm font-bold xl:text-xl ml-2">
                <div class="flex mx-auto justify-center items-center">Beranda</div>
            </a>
        </div>
        <div class="sm:flex px-8 w-full pb-14">
            ...
            <div class="xl:flex-grow bg-white w-full xl:py-14 mt-4 rounded-xl shadow-2xl grid grid-cols-1 gap-4 mx-2">
                <div
                    class="sm:h-full py-4 px-2 sm:my-auto sm:flex mx-auto flex-col sm:justify-center sm:items-center relative">
                    <img src="assets/main/result/management Stres 1.png" alt="" class="flex mx-auto">
                    <div>
                        <h2 class="mt-4 text-lg font-bold text-center text-slate-800">Tips Manajemen Stres</h2>
