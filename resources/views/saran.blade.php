...
<body>
    ...
    <section id="hero"
        ...
        <div
            class="bg-white w-full mx-6 xl:mx-48 md:mt-auto md:mt-14 lg:mt-24 rounded-xl shadow-2xl grid grid-cols-1 sm:grid-cols-2 gap-4">

            <!-- Div Kedua - akan tampil di atas di tampilan mobile -->
            <div
                class="sm:h-full order-1 sm:order-2 py-14 px-2 sm:my-auto sm:flex sm:justify-center sm:items-center md:mt-0">
                <div>
                    <h2 class="sm:text-lg font-bold text-center text-slate-800 text-sm">Berikan Kami Kritik dan saran
                        setelah menggunakan
                        <br>MoodUp agar kami bisa lebih baik lagi kedepannya
                    </h2>
                    <div class="mt-6 mx-4 sm:mt-16">
                        <p class="text-sm text-center font-medium mb-2 text-slate-700">Masukkan Saran & Kritik anda !
                        </p>
                        <textarea id="nama" name="nama"
                            class="text-slate-700 border rounded-3xl py-2 px-4 bg-slate-100 w-full h-80 resize-none"></textarea>
                    </div>

                    <a href="index.html"><button
                            class="flex mx-auto border font-semibold text-slate-700 rounded-full py-2 px-4 bg-yellow-300 sm:mt-42 md:mt-20 mb-12 cursor-pointer">Kirim</button></a>
                </div>
            </div>

            <!-- Div Pertama -->
            <div class="rounded-xl shadow-xl p-4 flex flex-col order-2 sm:order-1 bg-center hidden sm:block"
                style="background-image: url('./assets/saran.png');">
